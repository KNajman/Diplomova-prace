...
proc init_gui { IPINST } {
  ...
  set C_MAX_LINE_WIDTH [ipgui::add_param $IPINST -name "C_MAX_LINE_WIDTH" -parent ${Page_0}]
  set_property tooltip {Maximum line width} ${C_MAX_LINE_WIDTH}
...
proc update_PARAM_VALUE.C_MAX_LINE_WIDTH { PARAM_VALUE.C_MAX_LINE_WIDTH } {
	# Procedure called to update C_MAX_LINE_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_MAX_LINE_WIDTH { PARAM_VALUE.C_MAX_LINE_WIDTH } {
	# Procedure called to validate C_MAX_LINE_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_MAX_LINE_WIDTH { MODELPARAM_VALUE.C_MAX_LINE_WIDTH PARAM_VALUE.C_MAX_LINE_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_MAX_LINE_WIDTH}] ${MODELPARAM_VALUE.C_MAX_LINE_WIDTH}
}
