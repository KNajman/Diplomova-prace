...
//
//==============================================================
`ifndef HLS_RGB_2_HSV_CONFIG__SV                        
    `define HLS_RGB_2_HSV_CONFIG__SV                    
                                                            
    class hls_rgb_2_hsv_config extends uvm_object;            
        ...
        `uvm_object_utils_begin(hls_rgb_2_hsv_config)         
        ...
        function new (string name = "hls_rgb_2_hsv_config");
            super.new(name);                                
