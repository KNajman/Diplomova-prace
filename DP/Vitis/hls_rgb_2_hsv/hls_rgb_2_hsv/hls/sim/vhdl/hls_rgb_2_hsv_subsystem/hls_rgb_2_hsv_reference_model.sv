...
`ifndef HLS_RGB_2_HSV_REFERENCE_MODEL_SV
`define HLS_RGB_2_HSV_REFERENCE_MODEL_SV

class hls_rgb_2_hsv_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(hls_rgb_2_hsv_reference_model)
