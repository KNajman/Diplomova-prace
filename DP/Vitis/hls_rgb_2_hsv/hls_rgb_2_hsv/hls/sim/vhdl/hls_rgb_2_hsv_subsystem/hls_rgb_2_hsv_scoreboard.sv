...
//
//==============================================================
`ifndef HLS_RGB_2_HSV_SCOREBOARD__SV                                                       
    `define HLS_RGB_2_HSV_SCOREBOARD__SV                                                   
                                                                                               
    `define AUTOTB_TVOUT_out_stream_out_stream_TDATA_wrapc  "../tv/rtldatafile/rtl.hls_rgb_2_hsv.autotvout_out_stream.dat"
    `define STREAM_SIZE_OUT_out_stream_out_stream_TDATA  "../tv/stream_size/stream_size_out_out_stream.dat"
                                                                                               
    class hls_rgb_2_hsv_scoreboard extends uvm_component;                                        
        ...
        file_agent_pkg::apctrlnone_file_write_agent#(32) file_wr_port_out_stream_out_stream_TDATA;
                                                                                               
        `uvm_component_utils_begin(hls_rgb_2_hsv_scoreboard)                                     
        ...
        virtual function void build_phase(uvm_phase phase);                                    
            ...
            file_wr_port_out_stream_out_stream_TDATA = file_agent_pkg::apctrlnone_file_write_agent#(32)::type_id::create("file_wr_port_out_stream_out_stream_TDATA", this);
        endfunction                                                                            
