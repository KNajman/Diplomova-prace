...
if {[file isfile hls_rgb_2_hsv.autotvin.dat]} {
	file delete -force hls_rgb_2_hsv.autotvin.dat
}

if {[file isfile hls_rgb_2_hsv.autotvout.dat]} {
	file delete -force hls_rgb_2_hsv.autotvout.dat
}
