...
`define AUTOTB_DUT      hls_rgb_2_hsv
`define AUTOTB_DUT_INST AESL_inst_hls_rgb_2_hsv
`define AUTOTB_TOP      apatb_hls_rgb_2_hsv_top
`define AUTOTB_LAT_RESULT_FILE "hls_rgb_2_hsv.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "hls_rgb_2_hsv.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_hls_rgb_2_hsv_top
...
`define AUTOTB_TVIN_in_stream  "../tv/cdatafile/c.hls_rgb_2_hsv.autotvin_in_stream.dat"
`define AUTOTB_TVIN_in_stream_out_wrapc  "../tv/rtldatafile/rtl.hls_rgb_2_hsv.autotvin_in_stream.dat"
`define AUTOTB_TVOUT_out_stream  "../tv/cdatafile/c.hls_rgb_2_hsv.autotvout_out_stream.dat"
`define AUTOTB_TVOUT_out_stream_out_wrapc  "../tv/rtldatafile/rtl.hls_rgb_2_hsv.autotvout_out_stream.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1008;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 5;
parameter LENGTH_in_stream = 1;
