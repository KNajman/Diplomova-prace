...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_rgb_2_hsv.autotvin.dat"
	set constFileTvOut       "hls_rgb_2_hsv.autotvout.dat"
	set constFileHdlTvIn     "hls_rgb_2_hsv.autohdltvin.dat"
	set constFileHdlTvOut    "hls_rgb_2_hsv.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
