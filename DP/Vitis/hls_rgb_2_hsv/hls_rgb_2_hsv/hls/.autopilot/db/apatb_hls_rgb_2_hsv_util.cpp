...
extern "C" bool fpga_direct_valid_5(hls::directio<__cosim_T_5__, 0>* direct) {
  return direct->valid();
}
extern "C" void fpga_direct_load_5(__cosim_T_5__* val, hls::directio<__cosim_T_5__, 0>* direct) {
  *val = direct->read();
}
extern "C" void fpga_direct_store_5(__cosim_T_5__* val, hls::directio<__cosim_T_5__, 0>* direct) {
  direct->write(*val);
}
