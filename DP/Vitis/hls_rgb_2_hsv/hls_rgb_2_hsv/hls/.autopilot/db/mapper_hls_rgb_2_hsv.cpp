...
using hls::sim::Byte;
extern "C" void hls_rgb_2_hsv(int*, int*);
extern "C" void apatb_hls_rgb_2_hsv_hw(volatile void * __xlx_apatb_param_in_stream, volatile void * __xlx_apatb_param_out_stream) {
...
auto* sout_stream = createStream((hls::stream<int>*)__xlx_apatb_param_out_stream);
  // DUT call
  hls_rgb_2_hsv(sin_stream->data<int>(), sout_stream->data<int>());
