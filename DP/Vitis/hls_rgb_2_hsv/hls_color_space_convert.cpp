...
void hls_color_space_convert_template(
    ...
    ap_int<16> coeffs[OUT_CH]
                     [IN_CH],   // Univerzální matice (např. 3x3, 4x4, 1x3)
    ap_int<16> offsets[OUT_CH], // Univerzální offset
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  // Volání naší HW-optimalizované generické šablony
...
/*
 ...
 Nahrazuje extrémně drahou hardwarovou děličku obyčejnou pamětí (BRAM/LUTRAM)
