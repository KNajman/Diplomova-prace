...
//
//==============================================================
`ifndef HLS_PASSTHROUGH_SUBSYS_TEST_SEQUENCE_LIB__SV                                              
    `define HLS_PASSTHROUGH_SUBSYS_TEST_SEQUENCE_LIB__SV                                          
                                                                                                    
    `define AUTOTB_TVIN_in_stream_in_stream_TDATA  "../tv/cdatafile/c.hls_passthrough.autotvin_in_stream_V_data_V.dat" 
    `define AUTOTB_TVIN_in_stream_in_stream_TKEEP  "../tv/cdatafile/c.hls_passthrough.autotvin_in_stream_V_keep_V.dat" 
    `define AUTOTB_TVIN_in_stream_in_stream_TSTRB  "../tv/cdatafile/c.hls_passthrough.autotvin_in_stream_V_strb_V.dat" 
    `define AUTOTB_TVIN_in_stream_in_stream_TUSER  "../tv/cdatafile/c.hls_passthrough.autotvin_in_stream_V_user_V.dat" 
    `define AUTOTB_TVIN_in_stream_in_stream_TLAST  "../tv/cdatafile/c.hls_passthrough.autotvin_in_stream_V_last_V.dat" 
                                                                                                    
    `include "uvm_macros.svh"                                                                     
                                                                                                    
    class hls_passthrough_subsys_test_sequence_lib extends uvm_sequence;                                
                                                                                                    
        function new (string name = "hls_passthrough_subsys_test_sequence_lib");                      
            super.new(name);                                                                        
            `uvm_info(this.get_full_name(), "new is called", UVM_LOW)                             
        endfunction                                                                                 
                                                                                                    
        `uvm_object_utils(hls_passthrough_subsys_test_sequence_lib)                                     
        `uvm_declare_p_sequencer(hls_passthrough_virtual_sequencer)                                     
                ...
                begin
                    fork
                        begin
                            ...
                            if( refm.hls_passthrough_cfg.port_in_stream_cfg.prt_type == AP_VLD ) wait(refm.misc_if.tb2dut_ap_start === 1'b1);
