...
`define AUTOTB_DUT      hls_passthrough
`define AUTOTB_DUT_INST AESL_inst_hls_passthrough
`define AUTOTB_TOP      apatb_hls_passthrough_top
`define AUTOTB_LAT_RESULT_FILE "hls_passthrough.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "hls_passthrough.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_hls_passthrough_top
...
`define AUTOTB_TVOUT_out_stream_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.hls_passthrough.autotvout_out_stream_V_data_V.dat"
`define AUTOTB_TVOUT_out_stream_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.hls_passthrough.autotvout_out_stream_V_keep_V.dat"
`define AUTOTB_TVOUT_out_stream_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.hls_passthrough.autotvout_out_stream_V_strb_V.dat"
`define AUTOTB_TVOUT_out_stream_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.hls_passthrough.autotvout_out_stream_V_user_V.dat"
