...
//
//==============================================================
`ifndef HLS_PASSTHROUGH_CONFIG__SV                        
    `define HLS_PASSTHROUGH_CONFIG__SV                    
                                                            
    class hls_passthrough_config extends uvm_object;            
        ...
        `uvm_object_utils_begin(hls_passthrough_config)         
        ...
        function new (string name = "hls_passthrough_config");
            super.new(name);                                
