...
//
//==============================================================
`ifndef HLS_PASSTHROUGH_SCOREBOARD__SV                                                       
    `define HLS_PASSTHROUGH_SCOREBOARD__SV                                                   
                                                                                               
    `define AUTOTB_TVOUT_out_stream_out_stream_TDATA_wrapc  "../tv/rtldatafile/rtl.hls_passthrough.autotvout_out_stream_V_data_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TKEEP_wrapc  "../tv/rtldatafile/rtl.hls_passthrough.autotvout_out_stream_V_keep_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TSTRB_wrapc  "../tv/rtldatafile/rtl.hls_passthrough.autotvout_out_stream_V_strb_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TUSER_wrapc  "../tv/rtldatafile/rtl.hls_passthrough.autotvout_out_stream_V_user_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TLAST_wrapc  "../tv/rtldatafile/rtl.hls_passthrough.autotvout_out_stream_V_last_V.dat"
    ...
    class hls_passthrough_scoreboard extends uvm_component;                                        
        ...
        `uvm_component_utils_begin(hls_passthrough_scoreboard)                                     
        ...
        virtual function void build_phase(uvm_phase phase);                                    
            if (!uvm_config_db #(hls_passthrough_reference_model)::get(this, "", "refm", refm))
        ...
        virtual task run_phase(uvm_phase phase);                                               
            ...
            fork                                                                               
                ...
                begin                                                                      
                    forever begin                                                              
                        wait(write_section_done_out_stream_out_stream_TDATA && write_section_done_out_stream_out_stream_TKEEP && write_section_done_out_stream_out_stream_TSTRB && write_section_done_out_stream_out_stream_TUSER && write_section_done_out_stream_out_stream_TLAST);                          
