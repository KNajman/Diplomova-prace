...
static void hls_color_space_convert_template(
    ...
    const ap_int<16> coeffs[OUT_CH][IN_CH], const ap_int<16> offsets[OUT_CH],
...
void hls_color_space_convert_top(hls::stream<axis_rgb> &s_axis_video,
                                 hls::stream<axis_ycbcr> &m_axis_video,
                                 const ap_int<16> coeffs[3][3],
                                 const ap_int<16> offsets[3], int width,
                                 int height) {
