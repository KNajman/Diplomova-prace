...
//
//==============================================================
`ifndef HLS_COLOR_SPACE_CONVERT_TOP_SCOREBOARD__SV                                                       
    `define HLS_COLOR_SPACE_CONVERT_TOP_SCOREBOARD__SV                                                   
                                                                                               
    `define AUTOTB_TVOUT_m_axis_video_m_axis_video_TDATA_wrapc  "../tv/rtldatafile/rtl.hls_color_space_convert_top.autotvout_m_axis_video.dat"
    `define STREAM_SIZE_OUT_m_axis_video_m_axis_video_TDATA  "../tv/stream_size/stream_size_out_m_axis_video.dat"
                                                                                               
    class hls_color_space_convert_top_scoreboard extends uvm_component;                                        
        ...
        `uvm_component_utils_begin(hls_color_space_convert_top_scoreboard)                                     
        ...
        virtual task run_phase(uvm_phase phase);                                               
            ...
            fork                                                                               
                forever begin
                    ...
                    void'(refm.mem_blk_pages_control_coeffs_0_0.pages.pop_front());
                    void'(refm.mem_blk_pages_control_coeffs_0_1.pages.pop_front());
                    void'(refm.mem_blk_pages_control_coeffs_0_2.pages.pop_front());
                    void'(refm.mem_blk_pages_control_coeffs_1_0.pages.pop_front());
                    void'(refm.mem_blk_pages_control_coeffs_1_1.pages.pop_front());
                    void'(refm.mem_blk_pages_control_coeffs_1_2.pages.pop_front());
                    void'(refm.mem_blk_pages_control_coeffs_2_0.pages.pop_front());
                    void'(refm.mem_blk_pages_control_coeffs_2_1.pages.pop_front());
                    void'(refm.mem_blk_pages_control_coeffs_2_2.pages.pop_front());
                    void'(refm.mem_blk_pages_control_offsets_0.pages.pop_front());
                    void'(refm.mem_blk_pages_control_offsets_1.pages.pop_front());
                    void'(refm.mem_blk_pages_control_offsets_2.pages.pop_front());
