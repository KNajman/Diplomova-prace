...
if {[file isfile hls_color_space_convert_top.autotvin.dat]} {
	file delete -force hls_color_space_convert_top.autotvin.dat
}

if {[file isfile hls_color_space_convert_top.autotvout.dat]} {
	file delete -force hls_color_space_convert_top.autotvout.dat
}
