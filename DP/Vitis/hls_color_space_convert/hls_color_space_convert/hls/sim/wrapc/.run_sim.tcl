...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_color_space_convert_top.autotvin.dat"
	set constFileTvOut       "hls_color_space_convert_top.autotvout.dat"
	set constFileHdlTvIn     "hls_color_space_convert_top.autohdltvin.dat"
	set constFileHdlTvOut    "hls_color_space_convert_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
