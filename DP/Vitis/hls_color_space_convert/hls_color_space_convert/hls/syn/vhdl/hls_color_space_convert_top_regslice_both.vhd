...
entity hls_color_space_convert_top_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity hls_color_space_convert_top_regslice_both;

architecture behave of hls_color_space_convert_top_regslice_both is
