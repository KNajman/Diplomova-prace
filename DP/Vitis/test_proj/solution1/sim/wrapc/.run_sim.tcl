...
# 
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/AMDDesignTools/Vitis_HLS/2023.2/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);D:/AMDDesignTools/Vitis_HLS/2023.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/AMDDesignTools/Vitis_HLS/2023.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/AMDDesignTools/Vitis_HLS/2023.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_passthrough.autotvin.dat"
	set constFileTvOut       "hls_passthrough.autotvout.dat"
	set constFileHdlTvIn     "hls_passthrough.autohdltvin.dat"
	set constFileHdlTvOut    "hls_passthrough.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
