...
if {[file isfile hls_passthrough.autotvin.dat]} {
	file delete -force hls_passthrough.autotvin.dat
}

if {[file isfile hls_passthrough.autotvout.dat]} {
	file delete -force hls_passthrough.autotvout.dat
}
