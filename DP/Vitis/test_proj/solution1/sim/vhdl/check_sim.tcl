...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.hls_passthrough.autotvin_in_stream_V_data_V.dat"
         "c.hls_passthrough.autotvin_in_stream_V_keep_V.dat"
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.hls_passthrough.autotvout_out_stream_V_data_V.dat"
         "rtl.hls_passthrough.autotvout_out_stream_V_keep_V.dat"
         "rtl.hls_passthrough.autotvout_out_stream_V_strb_V.dat"
         "rtl.hls_passthrough.autotvout_out_stream_V_user_V.dat"
         "rtl.hls_passthrough.autotvout_out_stream_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
