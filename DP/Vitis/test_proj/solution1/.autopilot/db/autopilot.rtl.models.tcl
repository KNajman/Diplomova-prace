set SynModuleInfo {
  {SRCNAME hls_passthrough MODELNAME hls_passthrough RTLNAME hls_passthrough IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME hls_passthrough_regslice_both RTLNAME hls_passthrough_regslice_both BINDTYPE interface TYPE interface_regslice INSTNAME hls_passthrough_regslice_both_U}
    }
  }
}
