...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler hls_passthrough_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 12
set RegSliceName hls_passthrough_regslice_both
set RegSliceInstName hls_passthrough_regslice_both_U
set CoreName ap_simcore_hls_passthrough_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
