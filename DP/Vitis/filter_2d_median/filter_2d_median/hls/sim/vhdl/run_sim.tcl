...
if {[file isfile hls_filter_median_3x3.autotvin.dat]} {
	file delete -force hls_filter_median_3x3.autotvin.dat
}

if {[file isfile hls_filter_median_3x3.autotvout.dat]} {
	file delete -force hls_filter_median_3x3.autotvout.dat
}
