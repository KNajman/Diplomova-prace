...
`ifndef HLS_FILTER_MEDIAN_3X3_REFERENCE_MODEL_SV
`define HLS_FILTER_MEDIAN_3X3_REFERENCE_MODEL_SV

class hls_filter_median_3x3_reference_model extends uvm_component;
`define TV_IN_width "../tv/cdatafile/c.hls_filter_median_3x3.autotvin_width.dat"
`define TV_OUT_width ""
`define TV_IN_height "../tv/cdatafile/c.hls_filter_median_3x3.autotvin_height.dat"
`define TV_OUT_height ""
    ...
    `uvm_component_utils_begin(hls_filter_median_3x3_reference_model)
