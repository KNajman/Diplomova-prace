...
//
//==============================================================
`ifndef HLS_FILTER_MEDIAN_3X3_SCOREBOARD__SV                                                       
    `define HLS_FILTER_MEDIAN_3X3_SCOREBOARD__SV                                                   
                                                                                               
    `define AUTOTB_TVOUT_m_axis_video_m_axis_video_TDATA_wrapc  "../tv/rtldatafile/rtl.hls_filter_median_3x3.autotvout_m_axis_video.dat"
    `define STREAM_SIZE_OUT_m_axis_video_m_axis_video_TDATA  "../tv/stream_size/stream_size_out_m_axis_video.dat"
                                                                                               
    class hls_filter_median_3x3_scoreboard extends uvm_component;                                        
        ...
        `uvm_component_utils_begin(hls_filter_median_3x3_scoreboard)                                     
