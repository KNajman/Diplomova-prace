...
//
//==============================================================
`ifndef HLS_FILTER_MEDIAN_3X3_CONFIG__SV                        
    `define HLS_FILTER_MEDIAN_3X3_CONFIG__SV                    
                                                            
    class hls_filter_median_3x3_config extends uvm_object;            
        ...
        `uvm_object_utils_begin(hls_filter_median_3x3_config)         
        ...
        function new (string name = "hls_filter_median_3x3_config");
            super.new(name);                                
