...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.hls_filter_median_3x3.autotvin_s_axis_video.dat"
         "c.hls_filter_median_3x3.autotvin_width.dat"
         "c.hls_filter_median_3x3.autotvin_height.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.hls_filter_median_3x3.autotvout_m_axis_video.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
