...
entity hls_filter_median_3x3_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity hls_filter_median_3x3_regslice_both;

architecture behave of hls_filter_median_3x3_regslice_both is
