set moduleName hls_filter_median_3x3_Pipeline_VITIS_LOOP_34_1
set isTopModule 0
...
set cdfgNum 4
set C_modelName {hls_filter_median_3x3_Pipeline_VITIS_LOOP_34_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ mul_ln34 int 26 regular  }
	{ add_ln134 int 14 regular  }
	{ s_axis_video int 24 regular {axi_s 0 volatile  { s_axis_video Data } }  }
	{ add_ln116 int 14 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mul_ln34", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln134", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "s_axis_video", "interface" : "axis", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln116", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ mul_ln34 sc_in sc_lv 26 signal 0 } 
	{ add_ln134 sc_in sc_lv 14 signal 1 } 
	{ s_axis_video_TDATA sc_in sc_lv 24 signal 2 } 
	{ s_axis_video_TREADY sc_out sc_logic 1 inacc 2 } 
	{ add_ln116 sc_in sc_lv 14 signal 3 } 
	{ m_axis_video_TDATA sc_out sc_lv 24 signal 4 } 
	{ m_axis_video_TVALID sc_out sc_logic 1 outvld 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_ln34", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "mul_ln34", "role": "default" }} , 
 	{ "name": "add_ln134", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "add_ln134", "role": "default" }} , 
 	...
 	{ "name": "add_ln116", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "add_ln116", "role": "default" }} , 
...
set Spec2ImplPortList { 
	mul_ln34 { ap_none {  { mul_ln34 in_data 0 26 } } }
	add_ln134 { ap_none {  { add_ln134 in_data 0 14 } } }
	s_axis_video { axis {  { s_axis_video_TVALID in_vld 0 1 }  { s_axis_video_TDATA in_data 0 24 }  { s_axis_video_TREADY in_acc 1 1 } } }
	add_ln116 { ap_none {  { add_ln116 in_data 0 14 } } }
