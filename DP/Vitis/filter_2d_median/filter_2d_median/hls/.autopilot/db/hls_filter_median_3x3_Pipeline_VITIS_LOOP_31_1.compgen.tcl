...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler hls_filter_median_3x3_hls_filter_median_3x3_Pipeline_VITIS_LOOP_31_1_line_buffer_1_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
