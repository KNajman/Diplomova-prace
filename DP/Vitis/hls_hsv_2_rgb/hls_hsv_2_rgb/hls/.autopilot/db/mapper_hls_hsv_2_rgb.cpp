...
using hls::sim::Byte;
extern "C" void hls_hsv_2_rgb(int*, int*);
extern "C" void apatb_hls_hsv_2_rgb_hw(volatile void * __xlx_apatb_param_in_stream, volatile void * __xlx_apatb_param_out_stream) {
...
auto* sout_stream = createStream((hls::stream<int>*)__xlx_apatb_param_out_stream);
  // DUT call
  hls_hsv_2_rgb(sin_stream->data<int>(), sout_stream->data<int>());
