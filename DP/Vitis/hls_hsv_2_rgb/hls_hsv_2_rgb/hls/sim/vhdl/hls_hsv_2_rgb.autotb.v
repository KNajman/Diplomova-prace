...
`define AUTOTB_DUT      hls_hsv_2_rgb
`define AUTOTB_DUT_INST AESL_inst_hls_hsv_2_rgb
`define AUTOTB_TOP      apatb_hls_hsv_2_rgb_top
`define AUTOTB_LAT_RESULT_FILE "hls_hsv_2_rgb.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "hls_hsv_2_rgb.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_hls_hsv_2_rgb_top
...
`define AUTOTB_TVIN_in_stream  "../tv/cdatafile/c.hls_hsv_2_rgb.autotvin_in_stream.dat"
`define AUTOTB_TVIN_in_stream_out_wrapc  "../tv/rtldatafile/rtl.hls_hsv_2_rgb.autotvin_in_stream.dat"
`define AUTOTB_TVOUT_out_stream  "../tv/cdatafile/c.hls_hsv_2_rgb.autotvout_out_stream.dat"
`define AUTOTB_TVOUT_out_stream_out_wrapc  "../tv/rtldatafile/rtl.hls_hsv_2_rgb.autotvout_out_stream.dat"
module `AUTOTB_TOP;
