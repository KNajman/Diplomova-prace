...
if {[file isfile hls_hsv_2_rgb.autotvin.dat]} {
	file delete -force hls_hsv_2_rgb.autotvin.dat
}

if {[file isfile hls_hsv_2_rgb.autotvout.dat]} {
	file delete -force hls_hsv_2_rgb.autotvout.dat
}
