...
//
//==============================================================
`ifndef HLS_HSV_2_RGB_CONFIG__SV                        
    `define HLS_HSV_2_RGB_CONFIG__SV                    
                                                            
    class hls_hsv_2_rgb_config extends uvm_object;            
        ...
        `uvm_object_utils_begin(hls_hsv_2_rgb_config)         
        ...
        function new (string name = "hls_hsv_2_rgb_config");
            super.new(name);                                
