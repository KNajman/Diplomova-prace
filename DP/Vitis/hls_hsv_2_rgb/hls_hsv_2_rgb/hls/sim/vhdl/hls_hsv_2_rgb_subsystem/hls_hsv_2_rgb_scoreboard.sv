...
//
//==============================================================
`ifndef HLS_HSV_2_RGB_SCOREBOARD__SV                                                       
    `define HLS_HSV_2_RGB_SCOREBOARD__SV                                                   
                                                                                               
    `define AUTOTB_TVOUT_out_stream_out_stream_TDATA_wrapc  "../tv/rtldatafile/rtl.hls_hsv_2_rgb.autotvout_out_stream.dat"
    `define STREAM_SIZE_OUT_out_stream_out_stream_TDATA  "../tv/stream_size/stream_size_out_out_stream.dat"
                                                                                               
    class hls_hsv_2_rgb_scoreboard extends uvm_component;                                        
        ...
        `uvm_component_utils_begin(hls_hsv_2_rgb_scoreboard)                                     
