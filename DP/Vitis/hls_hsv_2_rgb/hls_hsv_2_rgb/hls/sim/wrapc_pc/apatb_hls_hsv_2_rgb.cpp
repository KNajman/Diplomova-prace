...
// tvout file define:
#define AUTOTB_TVOUT_PC_out_stream "../tv/rtldatafile/rtl.hls_hsv_2_rgb.autotvout_out_stream.dat"
...
extern "C"
void hls_hsv_2_rgb_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_hls_hsv_2_rgb_hw(void* __xlx_apatb_param_in_stream, void* __xlx_apatb_param_out_stream)
{
  ...
  try {
    ...
    hls_hsv_2_rgb_hw_stub_wrapper(__xlx_apatb_param_in_stream, __xlx_apatb_param_out_stream);
    port1.buffer();
