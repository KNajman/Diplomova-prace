...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_hsv_2_rgb.autotvin.dat"
	set constFileTvOut       "hls_hsv_2_rgb.autotvout.dat"
	set constFileHdlTvIn     "hls_hsv_2_rgb.autohdltvin.dat"
	set constFileHdlTvOut    "hls_hsv_2_rgb.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
