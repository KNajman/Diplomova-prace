set moduleName hls_histogram_gray_Pipeline_VITIS_LOOP_22_1
set isTopModule 0
...
set cdfgNum 6
set C_modelName {hls_histogram_gray_Pipeline_VITIS_LOOP_22_1}
...
set C_modelArgList {
	{ local_hist int 32 regular {array 256 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "local_hist", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ local_hist_we0 sc_out sc_logic 1 signal 0 } 
	{ local_hist_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	local_hist { ap_memory {  { local_hist_address0 mem_address 1 8 }  { local_hist_ce0 mem_ce 1 1 }  { local_hist_we0 mem_we 1 1 }  { local_hist_d0 mem_din 1 32 } } }
}
