...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_histogram_gray.autotvin.dat"
	set constFileTvOut       "hls_histogram_gray.autotvout.dat"
	set constFileHdlTvIn     "hls_histogram_gray.autohdltvin.dat"
	set constFileHdlTvOut    "hls_histogram_gray.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
