...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.hls_histogram_gray.autotvin_stream_in.dat"
         "c.hls_histogram_gray.autotvin_width.dat"
         "c.hls_histogram_gray.autotvin_height.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.hls_histogram_gray.autotvout_hist_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
