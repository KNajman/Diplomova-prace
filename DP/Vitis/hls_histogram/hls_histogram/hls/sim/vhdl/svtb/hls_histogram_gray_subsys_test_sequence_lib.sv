...
//
//==============================================================
`ifndef HLS_HISTOGRAM_GRAY_SUBSYS_TEST_SEQUENCE_LIB__SV                                              
    `define HLS_HISTOGRAM_GRAY_SUBSYS_TEST_SEQUENCE_LIB__SV                                          
                                                                                                    
    `define AUTOTB_TVIN_stream_in_stream_in_TDATA  "../tv/cdatafile/c.hls_histogram_gray.autotvin_stream_in.dat" 
                                                                                                    
    `include "uvm_macros.svh"                                                                     
                                                                                                    
    class hls_histogram_gray_subsys_test_sequence_lib extends uvm_sequence;                                
                                                                                                    
        function new (string name = "hls_histogram_gray_subsys_test_sequence_lib");                      
            super.new(name);                                                                        
            `uvm_info(this.get_full_name(), "new is called", UVM_LOW)                             
        endfunction                                                                                 
                                                                                                    
        `uvm_object_utils(hls_histogram_gray_subsys_test_sequence_lib)                                     
        `uvm_declare_p_sequencer(hls_histogram_gray_virtual_sequencer)                                     
        ...
        virtual task body();                                                                        
            ...
            string file_queue_stream_in [$];                                                         
            integer bitwidth_queue_stream_in [$];                                                    
                                                                                                               
            svr_pkg::svr_master_sequence#(24) svr_port_stream_in_seq;            
            svr_pkg::svr_random_sequence#(24) svr_port_random_port_stream_in_seq;

            axi_pkg::axi_busdatas_master_sequence#(11, 32) axi_master_wr_control_seq;
            axi_pkg::axi_busdatas_master_sequence#(11, 32) axi_master_rd_control_seq;
            axi_pkg::axi_busdatas_master_sequence#(11, 32) axi_master_poll_control_seq;

            if (!uvm_config_db#(hls_histogram_gray_reference_model)::get(p_sequencer,"", "refm", refm))
            ...
            fork
                begin
                    fork
                        begin
                            string keystr_delay;
                            file_queue_stream_in.push_back(`AUTOTB_TVIN_stream_in_stream_in_TDATA);
                            bitwidth_queue_stream_in.push_back(24);

                            `uvm_create_on(svr_port_stream_in_seq, p_sequencer.svr_port_stream_in_sqr);
                            svr_port_stream_in_seq.misc_if = refm.misc_if;
                            svr_port_stream_in_seq.ap_done  = refm.ap_done_for_nexttrans ;
                            svr_port_stream_in_seq.ap_ready = refm.ap_ready_for_nexttrans;
                            svr_port_stream_in_seq.finish   = refm.finish;
                            svr_port_stream_in_seq.file_rd.config_file(file_queue_stream_in, bitwidth_queue_stream_in);
                            if( refm.hls_histogram_gray_cfg.port_stream_in_cfg.prt_type == AP_VLD ) wait(refm.misc_if.tb2dut_ap_start === 1'b1);
                            svr_port_stream_in_seq.isusr_delay = svr_pkg::NO_DELAY;
                            `uvm_send(svr_port_stream_in_seq);     
                        end                                               
                        begin
                        ...
                        begin
                            ...
                            for(int j=0; j<3; j=j+refm.ap_done_cnt) begin
                                ...
                                @refm.dut2tb_ap_done;
                                axi_master_rd_control_seq.datamerge_inavg(databusbit, (256*32+32-1)/32, 1024, 0);
                        ...
                        begin
                            wait(svr_port_stream_in_seq);
                            forever begin
                                wait(svr_port_stream_in_seq.one_sect_read);
                                svr_port_stream_in_seq.one_sect_read = 0;
            ...
            p_sequencer.svr_port_stream_in_sqr.stop_sequences();
