...
// 
// ==============================================================
#ifndef XHLS_THRESHOLD_GRAY_H
#define XHLS_THRESHOLD_GRAY_H
...
#include <stddef.h>
#endif
#include "xhls_threshold_gray_hw.h"
...
#ifndef __linux__
#define XHls_threshold_gray_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XHls_threshold_gray_ReadReg(BaseAddress, RegOffset) \
...
#else
int XHls_threshold_gray_Initialize(XHls_threshold_gray *InstancePtr, const char* InstanceName);
int XHls_threshold_gray_Release(XHls_threshold_gray *InstancePtr);
#endif
