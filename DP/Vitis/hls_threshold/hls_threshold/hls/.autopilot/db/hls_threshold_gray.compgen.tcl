...
set name hls_threshold_gray_mul_32s_32s_32_1_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 8 \
			corename hls_threshold_gray_control_axilite \
			name hls_threshold_gray_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler hls_threshold_gray_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler hls_threshold_gray_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
