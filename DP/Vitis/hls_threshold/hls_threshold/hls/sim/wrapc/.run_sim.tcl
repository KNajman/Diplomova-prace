...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_threshold_gray.autotvin.dat"
	set constFileTvOut       "hls_threshold_gray.autotvout.dat"
	set constFileHdlTvIn     "hls_threshold_gray.autohdltvin.dat"
	set constFileHdlTvOut    "hls_threshold_gray.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
