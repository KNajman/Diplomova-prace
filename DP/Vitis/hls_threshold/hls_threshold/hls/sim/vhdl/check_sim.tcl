...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.hls_threshold_gray.autotvin_s_axis_video.dat"
         "c.hls_threshold_gray.autotvin_thresh_val.dat"
         "c.hls_threshold_gray.autotvin_thresh_type.dat"
         "c.hls_threshold_gray.autotvin_width.dat"
         "c.hls_threshold_gray.autotvin_height.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.hls_threshold_gray.autotvout_m_axis_video.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
