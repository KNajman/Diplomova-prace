...
if {[file isfile hls_threshold_gray.autotvin.dat]} {
	file delete -force hls_threshold_gray.autotvin.dat
}

if {[file isfile hls_threshold_gray.autotvout.dat]} {
	file delete -force hls_threshold_gray.autotvout.dat
}
