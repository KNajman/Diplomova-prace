...
`ifndef HLS_THRESHOLD_GRAY_REFERENCE_MODEL_SV
`define HLS_THRESHOLD_GRAY_REFERENCE_MODEL_SV

class hls_threshold_gray_reference_model extends uvm_component;
`define TV_IN_thresh_val "../tv/cdatafile/c.hls_threshold_gray.autotvin_thresh_val.dat"
`define TV_OUT_thresh_val ""
`define TV_IN_thresh_type "../tv/cdatafile/c.hls_threshold_gray.autotvin_thresh_type.dat"
`define TV_OUT_thresh_type ""
`define TV_IN_width "../tv/cdatafile/c.hls_threshold_gray.autotvin_width.dat"
`define TV_OUT_width ""
`define TV_IN_height "../tv/cdatafile/c.hls_threshold_gray.autotvin_height.dat"
`define TV_OUT_height ""
    ...
    mem_model_pages#(8,8) mem_blk_pages_control_thresh_val;
    mem_model_pages#(2,8) mem_blk_pages_control_thresh_type;
    ...
    `uvm_component_utils_begin(hls_threshold_gray_reference_model)
...
misc_if.dut2tb_ap_done = 0;
        ...
        fpath.push_back(`TV_IN_thresh_val);
        mem_blk_pages_control_thresh_val = mem_model_pages#(8,8)::type_id::create("mem_blk_pages_control_thresh_val");
        mem_blk_pages_control_thresh_val.tvinload_pagechk_atinit(fpath, 1*((8+7)/8), 0, 16);
        fpath.delete;


        fpath.push_back(`TV_IN_thresh_type);
        mem_blk_pages_control_thresh_type = mem_model_pages#(2,8)::type_id::create("mem_blk_pages_control_thresh_type");
        mem_blk_pages_control_thresh_type.tvinload_pagechk_atinit(fpath, 1*((2+7)/8), 0, 24);
        fpath.delete;


        fpath.push_back(`TV_IN_width);
        mem_blk_pages_control_width = mem_model_pages#(32,8)::type_id::create("mem_blk_pages_control_width");
        mem_blk_pages_control_width.tvinload_pagechk_atinit(fpath, 1*((32+7)/8), 0, 32);
        fpath.delete;
        ...
        mem_blk_pages_control_height.tvinload_pagechk_atinit(fpath, 1*((32+7)/8), 0, 40);
        fpath.delete;
