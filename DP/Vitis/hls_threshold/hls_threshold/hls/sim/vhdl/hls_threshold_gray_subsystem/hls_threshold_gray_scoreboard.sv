...
//
//==============================================================
`ifndef HLS_THRESHOLD_GRAY_SCOREBOARD__SV                                                       
    `define HLS_THRESHOLD_GRAY_SCOREBOARD__SV                                                   
                                                                                               
    `define AUTOTB_TVOUT_m_axis_video_m_axis_video_TDATA_wrapc  "../tv/rtldatafile/rtl.hls_threshold_gray.autotvout_m_axis_video.dat"
    `define STREAM_SIZE_OUT_m_axis_video_m_axis_video_TDATA  "../tv/stream_size/stream_size_out_m_axis_video.dat"
                                                                                               
    class hls_threshold_gray_scoreboard extends uvm_component;                                        
        ...
        `uvm_component_utils_begin(hls_threshold_gray_scoreboard)                                     
        ...
        virtual task run_phase(uvm_phase phase);                                               
            ...
            fork                                                                               
                forever begin
                    ...
                    void'(refm.mem_blk_pages_control_thresh_val.pages.pop_front());
                    void'(refm.mem_blk_pages_control_thresh_type.pages.pop_front());
