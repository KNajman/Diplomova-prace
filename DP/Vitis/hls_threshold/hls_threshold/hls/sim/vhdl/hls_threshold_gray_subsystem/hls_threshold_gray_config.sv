...
//
//==============================================================
`ifndef HLS_THRESHOLD_GRAY_CONFIG__SV                        
    `define HLS_THRESHOLD_GRAY_CONFIG__SV                    
                                                            
    class hls_threshold_gray_config extends uvm_object;            
        ...
        `uvm_object_utils_begin(hls_threshold_gray_config)         
        ...
        function new (string name = "hls_threshold_gray_config");
            super.new(name);                                
