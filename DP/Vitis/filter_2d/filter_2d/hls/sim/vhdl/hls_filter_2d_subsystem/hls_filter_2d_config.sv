...
//
//==============================================================
`ifndef HLS_FILTER_2D_CONFIG__SV                        
    `define HLS_FILTER_2D_CONFIG__SV                    
                                                            
    class hls_filter_2d_config extends uvm_object;            
        ...
        `uvm_object_utils_begin(hls_filter_2d_config)         
        ...
        function new (string name = "hls_filter_2d_config");
            super.new(name);                                
