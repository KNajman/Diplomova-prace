...
if {[file isfile hls_filter_2d.autotvin.dat]} {
	file delete -force hls_filter_2d.autotvin.dat
}

if {[file isfile hls_filter_2d.autotvout.dat]} {
	file delete -force hls_filter_2d.autotvout.dat
}
