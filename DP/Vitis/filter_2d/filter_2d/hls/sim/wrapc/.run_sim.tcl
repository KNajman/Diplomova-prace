...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_filter_2d.autotvin.dat"
	set constFileTvOut       "hls_filter_2d.autotvout.dat"
	set constFileHdlTvIn     "hls_filter_2d.autohdltvin.dat"
	set constFileHdlTvOut    "hls_filter_2d.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
