namespace eval ::optrace {
  variable script "D:/Repos/_DP/DP/Vivado/KriaTester/KriaTester.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir D:/Repos/_DP/DP/Vivado/KriaTester/KriaTester.cache/wt [current_project]
  set_property parent.project_path D:/Repos/_DP/DP/Vivado/KriaTester/KriaTester.xpr [current_project]
  set_property ip_repo_paths D:/Repos/_DP/DP/ip_repo [current_project]
  update_ip_catalog
  set_property ip_output_repo D:/Repos/_DP/DP/Vivado/KriaTester/KriaTester.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet D:/Repos/_DP/DP/Vivado/KriaTester/KriaTester.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files D:/Repos/_DP/DP/Vivado/KriaTester/KriaTester.srcs/sources_1/bd/design_1/design_1.bd
