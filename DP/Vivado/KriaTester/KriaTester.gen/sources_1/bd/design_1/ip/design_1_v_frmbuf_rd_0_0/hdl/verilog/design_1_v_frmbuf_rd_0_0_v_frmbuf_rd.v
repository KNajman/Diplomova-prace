...
(* CORE_GENERATION_INFO="design_1_v_frmbuf_rd_0_0_v_frmbuf_rd,hls_ip_2025_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LV-c,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=8,HLS_SYN_DSP=0,HLS_SYN_FF=2309,HLS_SYN_LUT=3508,HLS_VERSION=2025_2}" *)
...
wire  signed [13:0] trunc_ln135_fu_196_p1;
reg  signed [13:0] trunc_ln135_reg_238;
wire   [5:0] trunc_ln135_1_fu_200_p1;
reg   [5:0] trunc_ln135_1_reg_243;
wire   [10:0] trunc_ln135_2_fu_204_p1;
reg   [10:0] trunc_ln135_2_reg_248;
wire   [10:0] trunc_ln135_3_fu_208_p1;
reg   [10:0] trunc_ln135_3_reg_253;
wire   [13:0] WidthInBytes_fu_222_p2;
reg   [13:0] WidthInBytes_reg_268;
wire    ap_CS_fsm_state2;
reg   [2:0] colorFormat_reg_273;
...
wire   [31:0] zext_ln255_fu_212_p1;
...
initial begin
#0 ap_CS_fsm = 4'd1;
#0 frm_buffer_read_reg_228 = 32'd0;
#0 stride_read_reg_233 = 16'd0;
#0 trunc_ln135_reg_238 = 14'd0;
#0 trunc_ln135_1_reg_243 = 6'd0;
#0 trunc_ln135_2_reg_248 = 11'd0;
#0 trunc_ln135_3_reg_253 = 11'd0;
#0 WidthInBytes_reg_268 = 14'd0;
#0 colorFormat_reg_273 = 3'd0;
...
design_1_v_frmbuf_rd_0_0_FrmbufRdHlsDataFlow grp_FrmbufRdHlsDataFlow_fu_166(
    ...
    .width_val2(trunc_ln135_2_reg_248),
    .height_val6(trunc_ln135_3_reg_253),
    .stride_val7(stride_read_reg_233),
    .video_format_val8(trunc_ln135_1_reg_243),
    .WidthInBytes_val10(WidthInBytes_reg_268),
    .colorFormat_val11(colorFormat_reg_273),
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        WidthInBytes_reg_268 <= 14'd0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            WidthInBytes_reg_268 <= WidthInBytes_fu_222_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        colorFormat_reg_273 <= 3'd0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            colorFormat_reg_273 <= MEMORY2LIVE_q0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state2) | ((ap_sync_grp_FrmbufRdHlsDataFlow_fu_166_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state3)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((grp_FrmbufRdHlsDataFlow_fu_166_m_axis_video_TVALID == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        trunc_ln135_1_reg_243 <= 6'd0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state1)) begin
            trunc_ln135_1_reg_243 <= trunc_ln135_1_fu_200_p1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        trunc_ln135_2_reg_248 <= 11'd0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state1)) begin
            trunc_ln135_2_reg_248 <= trunc_ln135_2_fu_204_p1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        trunc_ln135_3_reg_253 <= 11'd0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state1)) begin
            trunc_ln135_3_reg_253 <= trunc_ln135_3_fu_208_p1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        trunc_ln135_reg_238 <= 14'd0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state1)) begin
            trunc_ln135_reg_238 <= trunc_ln135_fu_196_p1;
        end
    end
end
...
assign BYTES_PER_PIXEL_address0 = zext_ln255_fu_212_p1;

assign MEMORY2LIVE_address0 = zext_ln255_fu_212_p1;
...
always @ (*) begin
    ap_block_state3_on_subcall_done = ((ap_sync_reg_grp_FrmbufRdHlsDataFlow_fu_166_ap_ready & ap_sync_reg_grp_FrmbufRdHlsDataFlow_fu_166_ap_done) == 1'b0);
end
...
assign grp_FrmbufRdHlsDataFlow_fu_166_m_axis_video_TREADY = (m_axis_video_TREADY_int_regslice & ap_CS_fsm_state3);
...
assign trunc_ln135_1_fu_200_p1 = video_format[5:0];

assign trunc_ln135_2_fu_204_p1 = width[10:0];

assign trunc_ln135_3_fu_208_p1 = height[10:0];

assign trunc_ln135_fu_196_p1 = width[13:0];

assign zext_ln255_fu_212_p1 = video_format;
