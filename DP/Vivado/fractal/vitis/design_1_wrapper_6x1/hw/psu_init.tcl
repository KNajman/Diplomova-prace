...
set psu_pll_init_data {
    ...
    mask_write 0XFF5E0030 0x00717F00 0x00014700
		# : BY PASS PLL
		# Register : RPLL_CTRL @ 0XFF5E0030</p>
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070064 0x0FFF83FF 0x00798082
    ...
    mask_write 0XFD07012C 0x7F1F031F 0x1106010E
    ...
    mask_write 0XFD070184 0x3FFFFFFF 0x02017D6E
    ...
    mask_write 0XFD080044 0xFFFFFFFF 0xC34C1194
    ...
    mask_write 0XFD080110 0xFFFFFFFF 0x06200F08
    ...
    mask_write 0XFD080120 0xFFFFFFFF 0x01042B06
