...
//--------------------------------------------------------------------------------
//Command: generate_target bd_a9c8.bd
//Design : bd_a9c8
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_a9c8,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_a9c8,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "design_1_axi_smc_2_3.hwdef" *) 
module bd_a9c8
   (M00_AXI_awaddr,
    M00_AXI_awburst,
    M00_AXI_awcache,
  ...
  m00_exit_pipeline_imp_8AZUOY m00_exit_pipeline
       (.aclk(m_sc_clk_1),
  ...
  s00_entry_pipeline_imp_181ZGO1 s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_12PD263 s00_nodes
...
module m00_exit_pipeline_imp_8AZUOY
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awburst,
...
module s00_entry_pipeline_imp_181ZGO1
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awcache,
  ...
  bd_a9c8_s00mmu_0 s00_mmu
       (.aclk(aclk),
        ...
        .s_axi_wstrb(s_axi_wstrb),
        .s_axi_wvalid(s_axi_wvalid));
  bd_a9c8_s00sic_0 s00_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
        .m_axi_awaddr(m_axi_awaddr),
        .m_axi_awcache(m_axi_awcache),
  ...
  bd_a9c8_s00tr_0 s00_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
