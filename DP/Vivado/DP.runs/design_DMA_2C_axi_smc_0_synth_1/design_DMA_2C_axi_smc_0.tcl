...
namespace eval ::optrace {
  variable script "D:/Repos/_DP/DP/Vivado/DP.runs/design_DMA_2C_axi_smc_0_synth_1/design_DMA_2C_axi_smc_0.tcl"
...
OPTRACE "design_DMA_2C_axi_smc_0_synth_1" START { ROLLUP_AUTO }
...
read_ip -quiet D:/Repos/_DP/DP/Vivado/DP.srcs/sources_1/bd/design_DMA_2C/ip/design_DMA_2C_axi_smc_0/design_DMA_2C_axi_smc_0.xci
...
set cacheID [config_ip_cache -export -no_bom  -dir D:/Repos/_DP/DP/Vivado/DP.runs/design_DMA_2C_axi_smc_0_synth_1 -new_name design_DMA_2C_axi_smc_0 -ip [get_ips design_DMA_2C_axi_smc_0]]
...
synth_design -top design_DMA_2C_axi_smc_0 -part xck26-sfvc784-2LV-c -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix design_DMA_2C_axi_smc_0_ design_DMA_2C_axi_smc_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_DMA_2C_axi_smc_0_stub.v
 lappend ipCachedFiles design_DMA_2C_axi_smc_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_DMA_2C_axi_smc_0_stub.vhdl
 lappend ipCachedFiles design_DMA_2C_axi_smc_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_DMA_2C_axi_smc_0_sim_netlist.v
 lappend ipCachedFiles design_DMA_2C_axi_smc_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_DMA_2C_axi_smc_0_sim_netlist.vhdl
 lappend ipCachedFiles design_DMA_2C_axi_smc_0_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp design_DMA_2C_axi_smc_0.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips design_DMA_2C_axi_smc_0]
 }
...
rename_ref -prefix_all design_DMA_2C_axi_smc_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef design_DMA_2C_axi_smc_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file design_DMA_2C_axi_smc_0_utilization_synth.rpt -pb design_DMA_2C_axi_smc_0_utilization_synth.pb"  } 
OPTRACE "synth reports" END { }

if { [catch {
  file copy -force D:/Repos/_DP/DP/Vivado/DP.runs/design_DMA_2C_axi_smc_0_synth_1/design_DMA_2C_axi_smc_0.dcp d:/Repos/_DP/DP/Vivado/DP.gen/sources_1/bd/design_DMA_2C/ip/design_DMA_2C_axi_smc_0/design_DMA_2C_axi_smc_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub d:/Repos/_DP/DP/Vivado/DP.gen/sources_1/bd/design_DMA_2C/ip/design_DMA_2C_axi_smc_0/design_DMA_2C_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub d:/Repos/_DP/DP/Vivado/DP.gen/sources_1/bd/design_DMA_2C/ip/design_DMA_2C_axi_smc_0/design_DMA_2C_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim d:/Repos/_DP/DP/Vivado/DP.gen/sources_1/bd/design_DMA_2C/ip/design_DMA_2C_axi_smc_0/design_DMA_2C_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim d:/Repos/_DP/DP/Vivado/DP.gen/sources_1/bd/design_DMA_2C/ip/design_DMA_2C_axi_smc_0/design_DMA_2C_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/Repos/_DP/DP/Vivado/DP.runs/design_DMA_2C_axi_smc_0_synth_1/design_DMA_2C_axi_smc_0_stub.v d:/Repos/_DP/DP/Vivado/DP.gen/sources_1/bd/design_DMA_2C/ip/design_DMA_2C_axi_smc_0/design_DMA_2C_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Repos/_DP/DP/Vivado/DP.runs/design_DMA_2C_axi_smc_0_synth_1/design_DMA_2C_axi_smc_0_stub.vhdl d:/Repos/_DP/DP/Vivado/DP.gen/sources_1/bd/design_DMA_2C/ip/design_DMA_2C_axi_smc_0/design_DMA_2C_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Repos/_DP/DP/Vivado/DP.runs/design_DMA_2C_axi_smc_0_synth_1/design_DMA_2C_axi_smc_0_sim_netlist.v d:/Repos/_DP/DP/Vivado/DP.gen/sources_1/bd/design_DMA_2C/ip/design_DMA_2C_axi_smc_0/design_DMA_2C_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Repos/_DP/DP/Vivado/DP.runs/design_DMA_2C_axi_smc_0_synth_1/design_DMA_2C_axi_smc_0_sim_netlist.vhdl d:/Repos/_DP/DP/Vivado/DP.gen/sources_1/bd/design_DMA_2C/ip/design_DMA_2C_axi_smc_0/design_DMA_2C_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/Repos/_DP/DP/Vivado/DP.ip_user_files/ip/design_DMA_2C_axi_smc_0]} {
  catch { 
    file copy -force d:/Repos/_DP/DP/Vivado/DP.gen/sources_1/bd/design_DMA_2C/ip/design_DMA_2C_axi_smc_0/design_DMA_2C_axi_smc_0_stub.v D:/Repos/_DP/DP/Vivado/DP.ip_user_files/ip/design_DMA_2C_axi_smc_0
  }
}

if {[file isdir D:/Repos/_DP/DP/Vivado/DP.ip_user_files/ip/design_DMA_2C_axi_smc_0]} {
  catch { 
    file copy -force d:/Repos/_DP/DP/Vivado/DP.gen/sources_1/bd/design_DMA_2C/ip/design_DMA_2C_axi_smc_0/design_DMA_2C_axi_smc_0_stub.vhdl D:/Repos/_DP/DP/Vivado/DP.ip_user_files/ip/design_DMA_2C_axi_smc_0
  }
}
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "design_DMA_2C_axi_smc_0_synth_1" END { }
