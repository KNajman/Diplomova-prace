...
// Date        : Fri Feb 20 22:17:30 2026
// Host        : N166A running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub -rename_top design_1_rst_CLK_WIZ_300M_0 -prefix
//               design_1_rst_CLK_WIZ_300M_0_ design_1_rst_CLK_WIZ_100M_0_stub.v
...
module design_1_rst_CLK_WIZ_300M_0(slowest_sync_clk, ext_reset_in, aux_reset_in, 
...
/* synthesis syn_force_seq_prim="slowest_sync_clk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 clock CLK" *) (* x_interface_mode = "slave clock" *) (* x_interface_parameter = "XIL_INTERFACENAME clock, ASSOCIATED_RESET mb_reset:bus_struct_reset:interconnect_aresetn:peripheral_aresetn:peripheral_reset, FREQ_HZ 99999000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_clk_wiz_0_1_clk_out1, INSERT_VIP 0" *) input slowest_sync_clk /* synthesis syn_isclock = 1 */;
