...
// Date        : Fri Mar  6 14:54:34 2026
// Host        : N166A running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ MPSoC_ext_platform_part_axi_vip_pltf_0_stub.v
// Design      : MPSoC_ext_platform_part_axi_vip_pltf_0
...
(* CHECK_LICENSE_TYPE = "MPSoC_ext_platform_part_axi_vip_pltf_0,axi_vip_v1_1_22_top,{}" *) (* CORE_GENERATION_INFO = "MPSoC_ext_platform_part_axi_vip_pltf_0,axi_vip_v1_1_22_top,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_vip,x_ipVersion=1.1,x_ipCoreRevision=22,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_AXI_PROTOCOL=0,C_AXI_INTERFACE_MODE=2,C_AXI_ADDR_WIDTH=32,C_AXI_WDATA_WIDTH=32,C_AXI_RDATA_WIDTH=32,C_AXI_WID_WIDTH=0,C_AXI_RID_WIDTH=0,C_AXI_AWUSER_WIDTH=16,C_AXI_ARUSER_WIDTH=16,C_AXI_WUSER_WIDTH=0,C_AXI_RUSER_WIDTH=0,C_AXI_BUSER_WIDTH=0,C_AXI_SUPPORTS_NARROW=0,C_AXI_HAS_BURST=1,C_AXI_HAS_LOCK=1,C_AXI_HAS_CACHE=1,C_AXI_HAS_REGION=0,C_AXI_HAS_PROT=1,C_AXI_HAS_QOS=1,C_AXI_HAS_WSTRB=1,C_AXI_HAS_BRESP=1,C_AXI_HAS_RRESP=1,C_AXI_HAS_ARESETN=1}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
