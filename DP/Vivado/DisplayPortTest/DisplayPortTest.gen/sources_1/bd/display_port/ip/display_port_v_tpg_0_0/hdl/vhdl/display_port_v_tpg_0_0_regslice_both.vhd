...
entity display_port_v_tpg_0_0_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity display_port_v_tpg_0_0_regslice_both;

architecture behave of display_port_v_tpg_0_0_regslice_both is
