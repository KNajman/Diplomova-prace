...
// Command     : write_verilog -force -mode synth_stub -rename_top display_port_v_axi4s_vid_out_0_0 -prefix
//               display_port_v_axi4s_vid_out_0_0_ display_port_v_axi4s_vid_out_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "display_port_v_axi4s_vid_out_0_0,v_axi4s_vid_out_v4_0_20,{}" *) (* CORE_GENERATION_INFO = "display_port_v_axi4s_vid_out_0_0,v_axi4s_vid_out_v4_0_20,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=v_axi4s_vid_out,x_ipVersion=4.0,x_ipCoreRevision=20,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_FAMILY=zynquplus,C_PIXELS_PER_CLOCK=1,C_COMPONENTS_PER_PIXEL=3,C_S_AXIS_COMPONENT_WIDTH=8,C_NATIVE_COMPONENT_WIDTH=12,C_NATIVE_DATA_WIDTH=36,C_S_AXIS_TDATA_WIDTH=24,C_HAS_ASYNC_CLK=1,C_ADDR_WIDTH=10,C_VTG_MASTER_SLAVE=0,C_HYSTERESIS_LEVEL=12,C_SYNC_LOCK_THRESHOLD=4,C_INCLUDE_PIXEL_REPEAT=0,C_INCLUDE_PIXEL_REMAP_420=0,C_ADDR_WIDTH_PIXEL_REMAP_420=10,C_ARBITRARY_RES_EN=0}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "v_axi4s_vid_out_v4_0_20,Vivado 2025.2" *) 
module display_port_v_axi4s_vid_out_0_0(aclk, aclken, aresetn, s_axis_video_tdata, 
...
/* synthesis syn_force_seq_prim="vid_io_out_clk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 aclk_intf CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME aclk_intf, ASSOCIATED_BUSIF video_in, FREQ_HZ 297497025, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN display_port_clk_wiz_0_clk_a, INSERT_VIP 0" *) input aclk /* synthesis syn_isclock = 1 */;
  ...
  input fid;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 vid_io_out_clk_intf CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME vid_io_out_clk_intf, ASSOCIATED_BUSIF vid_io_out, FREQ_HZ 297497025, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN display_port_clk_wiz_0_clk_a, INSERT_VIP 0" *) input vid_io_out_clk /* synthesis syn_isclock = 1 */;
