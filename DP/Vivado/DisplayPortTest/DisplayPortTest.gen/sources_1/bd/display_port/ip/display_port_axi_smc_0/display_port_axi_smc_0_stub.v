...
// Date        : Fri Mar  6 15:42:28 2026
// Host        : N166A running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub -rename_top display_port_axi_smc_0 -prefix
//               display_port_axi_smc_0_ display_port_axi_smc_0_stub.v
// Design      : display_port_axi_smc_0
...
(* CHECK_LICENSE_TYPE = "display_port_axi_smc_0,bd_6b88,{}" *) (* CORE_GENERATION_INFO = "display_port_axi_smc_0,bd_6b88,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_6b88,Vivado 2025.2" *) 
module display_port_axi_smc_0(aclk, aclk1, aresetn, S00_AXI_awid, 
...
/* synthesis syn_force_seq_prim="aclk1" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 M01_AXI AWADDR" *) (* X_INTERFACE_MODE = "master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME M01_AXI, DATA_WIDTH 32, PROTOCOL AXI4LITE, FREQ_HZ 297497025, ID_WIDTH 0, ADDR_WIDTH 8, AWUSER_WIDTH 0, ARUSER_WIDTH 0, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, READ_WRITE_MODE READ_WRITE, HAS_BURST 0, HAS_LOCK 0, HAS_PROT 1, HAS_CACHE 0, HAS_QOS 0, HAS_REGION 0, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, SUPPORTS_NARROW_BURST 0, NUM_READ_OUTSTANDING 8, NUM_WRITE_OUTSTANDING 8, MAX_BURST_LENGTH 1, PHASE 0.0, CLK_DOMAIN display_port_clk_wiz_0_clk_a, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0" *) output [7:0]M01_AXI_awaddr;
