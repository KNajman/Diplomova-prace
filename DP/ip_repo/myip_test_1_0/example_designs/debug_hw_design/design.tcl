...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins myip_test_0/S00_AXI_DRIVE]
	connect_bd_net [get_bd_pins myip_test_0/s00_axi_drive_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins myip_test_0/s00_axi_drive_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of myip_test_0 streaming interfaces..
	connect_bd_net [get_bd_pins myip_test_0/s00_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins myip_test_0/s00_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins myip_test_0/m00_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins myip_test_0/m00_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to myip_test_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/myip_test_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_myip_test_0_S00_AXI_DRIVE_* ]]
	puts $fp "set s00_axi_drive_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/myip_test_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "myip_test_hw_${i}"
