...
proc init_gui { IPINST } {
  ...
  set C_FIFO_DEPTHS [ipgui::add_param $IPINST -name "C_FIFO_DEPTHS" -parent ${Page_0}]
  set_property tooltip {set any reasonable in/out FIFO depth} ${C_FIFO_DEPTHS}
...
proc update_PARAM_VALUE.C_FIFO_DEPTHS { PARAM_VALUE.C_FIFO_DEPTHS } {
	# Procedure called to update C_FIFO_DEPTHS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_FIFO_DEPTHS { PARAM_VALUE.C_FIFO_DEPTHS } {
	# Procedure called to validate C_FIFO_DEPTHS
	return true
}
...
proc update_MODELPARAM_VALUE.C_FIFO_DEPTHS { MODELPARAM_VALUE.C_FIFO_DEPTHS PARAM_VALUE.C_FIFO_DEPTHS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_FIFO_DEPTHS}] ${MODELPARAM_VALUE.C_FIFO_DEPTHS}
}
